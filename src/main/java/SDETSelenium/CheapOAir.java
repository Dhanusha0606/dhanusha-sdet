...
public class CheapOAir {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        WebElement eletrip=driver.findElement(By.id("onewayTrip"));
        driver.executeScript("arguments[0].click()", eletrip);
		//driver.findElement(By.id("onewayTrip")).click();

		WebElement elefrom=driver.findElement(By.id("from0"));
		elefrom.sendKeys(Keys.CONTROL,"a");
		elefrom.sendKeys(Keys.DELETE);
		elefrom.sendKeys("MAA",Keys.TAB);
